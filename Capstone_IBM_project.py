...
import ibm_db
# Connect to MySQL
connection = mysql.connector.connect(user='root', password='MTMxNDQtbXVnaWxh',host='127.0.0.1',database='sales')
# create cursor
...
dsn_uid = "cgz23184"        # e.g. "abc12345"
dsn_pwd = "LEThDWdZFPwQ733r"      # e.g. "7dBZ3wWt9XN6$o0J"
...
def insert_records(records):
    tuple_of_tuples = tuple([tuple(x) for x in new_records])
    SQL = "INSERT INTO sales_data(rowid,product_id,customer_id,
    quantity) VALUES(?,?,?,?);"
